...
export async function fetchToken(id, password) {
  try {
    ...
    if (token) {
      ...
      sessionStorage.setItem('user_id', userData.member_id)
      sessionStorage.setItem('user_role', userData.member_role)
      sessionStorage.setItem('user_name', userData.member_name)
      sessionStorage.setItem('user_unit', userData.member_unit)
      sessionStorage.setItem('user_unit_short', userData.member_unit_short)
